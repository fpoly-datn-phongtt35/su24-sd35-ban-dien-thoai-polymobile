...
public class SendMailUtil {
	...
	public void sendMailOrder(HoaDon hoaDon,String email) throws MessagingException, IOException {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<HoaDonChiTiet> listOrderDetails = hoaDonChiTietRepository.findByHoaDonId(hoaDon.getId());
		...
		content.append(
				"<td width=\"55%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;\"> Tổng tiền: </td>\r\n"
						...
						+ format(String.valueOf(hoaDon.getTongTienHoaDon())) + " </td>");
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "                                                            <p>"
						+ dt.format(Date.from(hoaDon.getCreatedAt())) + "</p>\r\n"
						+ "                                                        </td>\r\n"
						+ "                                                    </tr>\r\n"
						+ "                                                </table>\r\n"
						+ "                                            </div>\r\n"
						...
						+ "                                                            <p>" + hoaDon.getSoDienThoai()
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		sendMailService.send(new MailInfo(email, "Đặt hàng thành công", content.toString()));
	}

	public void sendMailOrderSuccess(HoaDon order,String email) throws MessagingException, IOException {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<HoaDonChiTiet> listOrderDetails = hoaDonChiTietRepository.findByHoaDonId(order.getId());
		StringBuilder content = new StringBuilder();
		...
		content.append(
				"<td width=\"55%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee;\"> Tổng tiền: </td>\r\n"
						+ "                                                    <td width=\"25%\" align=\"left\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 800; line-height: 24px; padding: 10px; border-top: 3px solid #eeeeee; border-bottom: 3px solid #eeeeee; color: red;\"> "
						+ format(String.valueOf(order.getTongTienHoaDon())) + " </td>");
		content.append(BODY3);
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						+ "                                                            <p style=\"font-weight: 800;\">Địa chỉ giao hàng</p>\r\n"
						...
						+ "                                                            <p style=\"font-weight: 800;\">Ngày đặt hàng</p>\r\n"
						+ "                                                            <p>"
						+ dt.format(Date.from(order.getCreatedAt())) + "</p>\r\n"
						+ "                                                        </td>\r\n"
						+ "                                                    </tr>\r\n"
						+ "                                                </table>\r\n"
						+ "                                            </div>\r\n"
						...
						+ "                                                        <td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						+ "                                                            <p style=\"font-weight: 800;\">Số điện thoại</p>\r\n"
						+ "                                                            <p>" + order.getSoDienThoai()
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		sendMailService.send(new MailInfo(email, "Thanh toán thành công", content.toString()));
	}

	public void sendMailOrderDeliver(HoaDon order,String email) throws MessagingException, IOException {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<HoaDonChiTiet> listOrderDetails = hoaDonChiTietRepository.findByHoaDonId(order.getId());
		StringBuilder content = new StringBuilder();
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		sendMailService.send(new MailInfo(email, "Đơn hàng đã được xác nhận", content.toString()));
	}

	public void sendMailOrderCancel(HoaDon hoaDon,String email) throws MessagingException, IOException {
		SimpleDateFormat dt = new SimpleDateFormat("dd-MM-yyyy");
		List<HoaDonChiTiet> listOrderDetails = hoaDonChiTietRepository.findByHoaDonId(hoaDon.getId());
		StringBuilder content = new StringBuilder();
		...
		content.append(
				"<td align=\"center\" valign=\"top\" style=\"font-family: Open sans-serif; font-size: 20px; font-weight: 400; line-height: 24px;\">\r\n"
						...
						+ "</p>\r\n" + "                                                        </td>");
		content.append(FOOTER);
		sendMailService.send(new MailInfo(email, "Huỷ đơn thành công", content.toString()));
	}
	...
	static String FOOTER = "</tr>\r\n" + "                                                </table>\r\n"
			...
			+ "                                            <p style=\"font-size: 18px; font-weight: 800; line-height: 18px; color: #fcb800;\"> PolyStore </p>\r\n"
