...
const apiURL = "/api/v1/san-pham-chi-tiet/tinh-nang-dac-biet";
let _existingNames;
$(document).attr("title", "Quản lý tính năng đặc biệt")
        ...
        return new Promise((resolve, reject) => {
            for (let obj of jsonData) {
                ...
                if (!obj.hasOwnProperty('ten')) {
                    reject("Lỗi định dạng: Thiếu tên tính năng đặc biệt")
                }
            }
            resolve(jsonData)
        })
